...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    title: 'Aplicacion',
    icon: 'nb-compose',
    link: '/pages/aplicacion',
    key: 'aplicacion',
    children: [
      {
        title: 'Lista Aplicacion',
        link: '/pages/aplicacion/list-aplicacion',
        key: 'lista_aplicacion',
      },
      {
        title: 'CRUD Aplicacion',
        link: '/pages/aplicacion/crud-aplicacion',
        key: 'crud_aplicacion',
      },
    ],
  },
  ...
  },
  {
    title: 'Menu Opcion',
    icon: 'nb-compose',
    link: '/pages/menu_opcion',
    key: 'menu_opcion',
    children: [
      {
        title: 'Lista Menu Opcion',
        link: '/pages/menu_opcion/list-menu_opcion',
        key: 'lista_menu_opcion',
      },
      {
        title: 'CRUD Menu Opcion',
        link: '/pages/menu_opcion/crud-menu_opcion',
        key: 'crud_menu_opcion',
      },
    ],
  },
  {
